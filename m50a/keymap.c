 ...
 */
[_LOWER] = LAYOUT(
    _______,  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR,  KC_ASTR,  RALT(KC_P), RALT(KC_Q), _______,
    _______, _______, _______, _______, KC_LPRN, KC_RPRN, KC_PIPE, KC_PLUS, KC_MINS,  KC_UNDS,      KC_EQL, RALT(KC_W), _______,
...
[_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, KC_LCBR, KC_RCBR, KC_LABK, KC_RABK, KC_LBRC, KC_RBRC, KC_QUOT, KC_DQUO, KC_INS,
